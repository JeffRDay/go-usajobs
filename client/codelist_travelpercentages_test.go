...
func TestTravelPercentages(t *testing.T) {
	testdata := "../testdata/travelpercentages-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/travelpercentages") {
	...
	_, _, err = c.TravelPercentages.WithOptions(nil)
	if err != nil {
