...
func TestSpecialHirings(t *testing.T) {
	testdata := "../testdata/specialhirings-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/specialhirings") {
	...
	_, _, err = c.SpecialHirings.WithOptions(nil)
	if err != nil {
