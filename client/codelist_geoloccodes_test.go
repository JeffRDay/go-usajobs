...
func TestGeoLocCodes(t *testing.T) {
	testdata := "../testdata/geoloccodes-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/geoloccodes") {
	...
	_, _, err = c.GeoLocCodes.WithOptions(nil)
	if err != nil {
