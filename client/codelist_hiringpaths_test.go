...
func TestHiringPaths(t *testing.T) {
	testdata := "../testdata/hiringpaths-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/hiringpaths") {
	...
	_, _, err = c.HiringPaths.WithOptions(nil)
	if err != nil {
