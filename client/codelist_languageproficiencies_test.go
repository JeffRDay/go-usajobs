...
func TestLanguageProficiencies(t *testing.T) {
	testdata := "../testdata/languageproficiencies-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/languageproficiencies") {
	...
	_, _, err = c.LanguageProficiencies.WithOptions(nil)
	if err != nil {
