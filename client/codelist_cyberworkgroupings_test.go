...
func TestCyberWorkGroupings(t *testing.T) {
	testdata := "../testdata/cyberworkgroupings-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/cyberworkgroupings") {
	...
	_, _, err = c.CyberWorkGroupings.WithOptions(nil)
	if err != nil {
