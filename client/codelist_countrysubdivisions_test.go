...
func TestCountrySubdivisions(t *testing.T) {
	testdata := "../testdata/countrysubdivisions-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/countrysubdivisions") {
	...
	_, _, err = c.CountrySubdivisions.WithOptions(nil)
	if err != nil {
