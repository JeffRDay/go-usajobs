...
func TestPayPlans(t *testing.T) {
	testdata := "../testdata/payplans-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/payplans") {
	...
	_, _, err = c.PayPlans.WithOptions(nil)
	if err != nil {
