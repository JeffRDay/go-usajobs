...
func TestFederalEmploymentStatuses(t *testing.T) {
	testdata := "../testdata/federalemploymentstatuses-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/federalemploymentstatuses") {
	...
	_, _, err = c.FederalEmploymentStatuses.WithOptions(nil)
	if err != nil {
