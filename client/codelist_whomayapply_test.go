...
func TestWhoMayApply(t *testing.T) {
	testdata := "../testdata/whomayapply-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/whomayapply") {
	...
	_, _, err = c.WhoMayApply.WithOptions(nil)
	if err != nil {
