...
func TestMilitaryStatusCodes(t *testing.T) {
	testdata := "../testdata/militarystatuscodes-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/militarystatuscodes") {
	...
	_, _, err = c.MilitaryStatusCodes.WithOptions(nil)
	if err != nil {
