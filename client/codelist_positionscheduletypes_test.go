...
func TestPositionScheduleTypes(t *testing.T) {
	testdata := "../testdata/positionscheduletypes-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/positionscheduletypes") {
	...
	_, _, err = c.PositionScheduleTypes.WithOptions(nil)
	if err != nil {
