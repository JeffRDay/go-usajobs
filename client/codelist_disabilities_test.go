...
func TestDisabilities(t *testing.T) {
	testdata := "../testdata/disabilities-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/disabilities") {
	...
	_, _, err = c.Disabilities.WithOptions(nil)
	if err != nil {
