...
func TestCyberWorkRoles(t *testing.T) {
	testdata := "../testdata/cyberworkroles-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/cyberworkroles") {
	...
	_, _, err = c.CyberWorkRoles.WithOptions(nil)
	if err != nil {
