...
func TestLocationExpansions(t *testing.T) {
	testdata := "../testdata/locationexpansions-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/locationexpansions") {
	...
	_, _, err = c.LocationExpansions.WithOptions(nil)
	if err != nil {
