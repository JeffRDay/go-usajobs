...
func TestRefereeTypeCodes(t *testing.T) {
	testdata := "../testdata/refereetypecodes-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/refereetypecodes") {
	...
	_, _, err = c.RefereeTypeCodes.WithOptions(nil)
	if err != nil {
