...
func TestDegreeTypeCodes(t *testing.T) {
	testdata := "../testdata/degreetypecodes-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/degreetypecodes") {
	...
	_, _, err = c.DegreeTypeCode.WithOptions(nil)
	if err != nil {
