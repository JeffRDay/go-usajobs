...
func TestRequiredStandardDocuments(t *testing.T) {
	testdata := "../testdata/requiredstandarddocuments-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/requiredstandarddocuments") {
	...
	_, _, err = c.RequiredStandardDocuments.WithOptions(nil)
	if err != nil {
