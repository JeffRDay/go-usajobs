...
func TestRemunerationRateIntervalCodes(t *testing.T) {
	testdata := "../testdata/remunerationrateintervalcodes-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/remunerationrateintervalcodes") {
	...
	_, _, err = c.RemunerationRateIntervalCodes.WithOptions(nil)
	if err != nil {
