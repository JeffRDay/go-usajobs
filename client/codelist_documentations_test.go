...
func TestDocumentations(t *testing.T) {
	testdata := "../testdata/documentations-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/documentations") {
	...
	_, _, err = c.Documentations.WithOptions(nil)
	if err != nil {
