...
func TestRaceCodes(t *testing.T) {
	testdata := "../testdata/racecodes-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/racecodes") {
	...
	_, _, err = c.RaceCodes.WithOptions(nil)
	if err != nil {
