...
func TestKeyStandardRequirements(t *testing.T) {
	testdata := "../testdata/keystandardrequirements-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/keystandardrequirements") {
	...
	_, _, err = c.KeyStandardRequirements.WithOptions(nil)
	if err != nil {
