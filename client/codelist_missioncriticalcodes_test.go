...
func TestMissionCriticalCodes(t *testing.T) {
	testdata := "../testdata/missioncriticalcodes-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/missioncriticalcodes") {
	...
	_, _, err = c.MissionCriticalCodes.WithOptions(nil)
	if err != nil {
