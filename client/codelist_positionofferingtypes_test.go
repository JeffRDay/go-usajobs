...
func TestPositionOfferingTypes(t *testing.T) {
	testdata := "../testdata/positionofferingtypes-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/positionofferingtypes") {
	...
	_, _, err = c.PositionOfferingTypes.WithOptions(nil)
	if err != nil {
