...
func TestGsaGeoLocCodes(t *testing.T) {
	testdata := "../testdata/gsageoloccodes-testdata.json"
	...
	mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(r.URL.String(), "/codelist/gsageoloccodes") {
	...
	_, _, err = c.GsaGeoLocCodes.WithOptions(nil)
	if err != nil {
